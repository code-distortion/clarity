...
/**
 * Test the SummaryMeta class.
 *
 * @phpcs:disable PSR1.Methods.CamelCapsMethodName.NotCamelCaps
 */
class SummaryMetaTest extends PHPUnitTestCase
{
    /**
     * Test the SummaryMeta class.
     *
     ...
     * @return void
     */
    public static function test_summary_meta(): void
    {
        $rand = mt_rand();
        ...
        foreach (['->', '::'] as $type) {
            ...
            $meta = new SummaryMeta($frameData, $projectFile, $summary);
            ...
            self::assertSame($summary, $meta->getSummary());
        }
    }
}
